...
var threeSumClosest = function (nums, target) {
  ...
  for (let i = 0; i < nums.length; i++) {
    ...
    while (L < R) {
      ...
      closestNumber = closestNumber !== null ? getClosestNumber(totalSum, closestNumber, target) : totalSum;
      if (closestNumber === target) return closestNumber;
      if (target >= totalSum) L++
      else R--
    }
  }
...
const getClosestNumber = (num1, num2, target) =>
  Math.abs(num1 - target) < Math.abs(num2 - target) ? num1 : num2;
